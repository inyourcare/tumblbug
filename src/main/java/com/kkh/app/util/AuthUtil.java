...
import com.kkh.app.exception.AuthExceptionCode;
...
public class AuthUtil {
    ...
    public static String isRegexName(String userName) throws Exception {
        ...
        if (!userName.matches(nameRegex))
            throw new Exception(AuthExceptionCode.USER_NAME_REGEX_ERROR.getMessage());
        return null;
    }
    ...
    public static String isRegexPhoneNo(String phoneNo) throws Exception {
        ...
        if (!phoneNo.matches(phoneNoRegex))
            throw new Exception(AuthExceptionCode.PHONE_NO_REGEX_ERROR.getMessage());
        return null;
    }
    ...
    public static String isRegexEmail(String email) throws Exception {
        ...
        if (!email.matches(emailRegex))
            throw new Exception(AuthExceptionCode.EMAIL_REGEX_ERROR.getMessage());
        return null;
    }
}
